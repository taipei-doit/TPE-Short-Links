...
_RAW_STRINGS: dict[str, dict[str, str]] = {
    "zh-Hant": {
        "title": "檔案下載",
        "heading": "檔案下載",
        "intro": "此檔案受 PIN 碼保護，請輸入提供者給您的 {len} 碼 PIN 碼。",
        "label_filename": "檔案名稱",
        "label_size": "檔案大小",
        "label_expiry": "有效期限",
    ...
    "en": {
        ...
        "intro": "This file is protected by a PIN. Please enter the {len}-character PIN you were given.",
        ...
        "submit": "Download",
        "verifying": "Verifying…",
        "verified": "Verified. Starting download…",
    ...
    "ja": {
        "title": "ファイルのダウンロード",
        "heading": "ファイルのダウンロード",
        "intro": "このファイルは PIN コードで保護されています。提供者から通知された {len} 桁の PIN コードを入力してください。",
    ...
    "ko": {
        "title": "파일 다운로드",
        "heading": "파일 다운로드",
        "intro": "이 파일은 PIN 번호로 보호되어 있습니다. 제공자에게 받은 {len}자리 PIN 번호를 입력하세요.",
